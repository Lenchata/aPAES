...
"[project]/src/app/api/admin/passkey/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!adminId) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Unauthorized'
        }, {
            status: 401
        });
        const body = await req.json();
        const admin = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminById"])(adminId);
        ...
        const verification = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$simplewebauthn$2f$server$2f$esm$2f$registration$2f$verifyRegistrationResponse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyRegistrationResponse"])({
            response: body,
        ...
        if (verification.verified && verification.registrationInfo) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveAdminCredential"])(adminId, {
                id,
                publicKey,
                counter,
                transports: body.response?.transports || []
            });
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveAdminChallenge"])(adminId, '');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                verified: true
            });
        } else {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0_q482t._.js.map