...
"[project]/src/app/api/auth/login/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const credentialRow = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM credentials WHERE id = ?').get(credentialId);
        if (!credentialRow) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No user associated with this credential'
            }, {
                status: 404
            });
        }
        const userId = credentialRow.user_id;
        const credentials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserCredentials"])(userId);
        ...
        if (verification.verified) {
            // Update counter
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('UPDATE credentials SET counter = ? WHERE id = ?').run(verification.authenticationInfo.newCounter, credentialId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__04grh-l._.js.map