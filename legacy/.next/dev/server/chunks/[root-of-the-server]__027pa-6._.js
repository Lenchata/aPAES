...
"[project]/src/app/api/auth/registration/options/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const existingUser = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getUserByUsername"])(username);
        if (existingUser) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveUserRegistrationOptions"])(userId, options.challenge, username);
        ...
        response.cookies.set('reg_user_id', userId, {
            httpOnly: true,
            secure: true,
            sameSite: 'strict',
            maxAge: 600
...
//# sourceMappingURL=%5Broot-of-the-server%5D__027pa-6._.js.map