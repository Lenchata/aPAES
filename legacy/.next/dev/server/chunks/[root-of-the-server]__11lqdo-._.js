...
"[project]/src/app/api/admin/passkey/login/verify/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    try {
        ...
        if (!challenge) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No admin login session found'
            }, {
                status: 400
            });
        }
        ...
        const credentialRow = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('SELECT * FROM admin_credentials WHERE id = ?').get(credentialId);
        if (!credentialRow) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'No admin associated with this credential'
            }, {
                status: 404
            });
        }
        const adminId = credentialRow.admin_id;
        const credentials = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminCredentials"])(adminId);
        ...
        const verification = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$simplewebauthn$2f$server$2f$esm$2f$authentication$2f$verifyAuthenticationResponse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["verifyAuthenticationResponse"])({
            response: body,
            expectedChallenge: challenge,
            expectedOrigin: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["origin"],
            expectedRPID: __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$auth_server$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["rpID"],
            credential: {
        ...
        if (verification.verified) {
            // Update counter
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].prepare('UPDATE admin_credentials SET counter = ? WHERE id = ?').run(verification.authenticationInfo.newCounter, credentialId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__11lqdo-._.js.map