...
function AdminDashboard() {
    ...
    const handleDeleteEntry = async (id, type)=>{
        if (!confirm(`¿Eliminar este ${type === 'admin' ? 'administrador' : 'usuario'} del sistema?`)) return;
        try {
            const res = await fetch('/api/admin/users', {
                method: 'DELETE',
                headers: {
...
_s(AdminDashboard, "gDKTeflC8ONJ/LhXpJNomc4OMAo=", false, function() {
    return [
...
//# sourceMappingURL=_02iisi5._.js.map